...
## 개발 목적
몇몇 사람들에겐 어린 시절, 동전 몇 개를 들고 문방구에서 반짝이는 카드를 사던 추억이 있을 겁니다.  <br>

이러한 기억을 현대적인 경험으로 재해석하여 사용자들에게 다시금 즐거움을 선사하고자 합니다. <br>

포켓몬이라는 친숙한 주제를 활용하여 포켓몬 카드를 수집하는 재미와 추억을 제공을 목표로 합니다.  <br>

특히, 단순히 수집에 그치지 않고 수집의 보상을 숨겨두어 시스템을 통해 사용자들이 자신의 도감을 채워나가며 재미를 느낄 수 있도록 기획되었습니다.  <br>
